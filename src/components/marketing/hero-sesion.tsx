						...
						<div className="mask-b-from-55% relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
							<div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
								...
								<img
									...
									src="/marketing/dashboard-light.png"
									alt="app screen"
									width="2700"
									height="1440"
								/>
			...
			<section className="bg-background pb-16 pt-16 md:pb-32">
				<div className="group relative m-auto max-w-5xl px-6">
					...
					<div className="group-hover:blur-xs mx-auto mt-12 grid max-w-2xl grid-cols-2 md:grid-cols-4 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14">
						<Icons.nvidia className="mx-auto size-5 w-fit dark:invert" />
						<Icons.column className="mx-auto size-5 w-fit dark:invert" />
						<Icons.github2 className="mx-auto size-5 w-fit dark:invert" />
						<Icons.nike className="mx-auto size-5 w-fit dark:invert" />
						<Icons.lemonsqueezy className="mx-auto size-5 w-fit dark:invert" />
						<Icons.laravel className="mx-auto size-5 w-fit dark:invert" />
						<Icons.lilly className="mx-auto size-5 w-fit dark:invert" />
						<Icons.openai className="mx-auto size-5 w-fit dark:invert" />
					</div>
				</div>
			</section>
		</main>
